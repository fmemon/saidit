	...
	describe "GET 'index'" do
		...
		describe "for signed-in users" do
			before(:each) do
				...
				third = Factory(:user, :email => "onemore@example.com")
  ...
  describe "GET 'show'" do
      ...
      response.should have_selector("h1>img", :class => "gravatar")
		...
		it "should show the user's microposts" do
			...
			mp2 = Factory(:micropost, :user => @user, :content => "Buzz buzz")
			get :show, :id => @user
    ...
    describe "success" do
			before(:each) do
				@attr = {:name => "New Name", :email => "user@see.org", :password => "foobar", :password_confirmation => "foobar"}
			end
